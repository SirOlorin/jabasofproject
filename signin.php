    ...
    if($_SERVER['REQUEST_METHOD'] != 'POST')
    {
        ...
        echo 
         '<form method="post" action="">
            <center>
                <h3 style="font-family:sans-serif; color: black; font-size: 10px;">ADRESSE E-MAIL</h3>
                <input type="text" name="user_name" id="email"/>
                <br><br>
                <h3 style="font-family:sans-serif; color: black; font-size: 10px;">MOT DE PASSE</h3>
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    echo "Bienvenue '".$_SESSION['user_name']."', cliquez ici <a href='forum.php'> pour revenir à l'accueil.";
                }
            }
        }
    }
